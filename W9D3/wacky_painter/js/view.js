...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  $("#easel").append("<h3>i love jquery</h3>");
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  function HandleClicked(pos) {
    alert(`You clicked on ${pos}`);
  }

  $(".square").on("click", (event) => {
    HandleClicked(event.currentTarget.getAttribute("data-pos"));
    // debugger
...
View.prototype.exercise6 = function () {
  ...
  // $(".square li").css("background-color", window._randomColorString());
  $(".square").each(function () {
    // debugger
    let that = $(this);
    that.css("background-color", window._randomColorString())
  });
};
